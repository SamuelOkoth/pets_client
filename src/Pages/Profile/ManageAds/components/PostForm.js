...
// Components
import { editAdAsync } from "../../../../store/reducers/ads.reducer";
...
const getAdsDetails = async ()=>{
  try{
    const response = await axiosClient.get(`api/v1/pets/${id}/edit`);
    setAdDetails(response.data.ad);
    console.log(response.data.ad.ad_type);
  }catch(error){
...
const handleAdSCreate = async (event) => {
  ...
  try {
    ...
    console.log("Error On editing add Form:", error?.response?.data?.error);
          ...
          <Row>
            <Col lg={12}>
              <div className="bg-primary-subtle text-primary p-3">
                <h5 className="mb-0 fs-17">{t("post_edit_ad_heading")}</h5>
              </div>
            </Col>
          </Row>
              ...
              <Row className="row">
                ...
                <Col lg={6}>
                  <div className="mb-4">
                    ...
                    <Input
                      ...
                      name="phone_number"
                      defaultValue={adDetails.phone_number}
                    />
                  </div>
                </Col>
                <Col lg={4}>
                  <div className="mb-4">
                    ...
                    <Input
                      ...
                      name="pet_type"
                      defaultValue={adDetails.pet_type}
                    />
                  </div>
                </Col>
                <Col lg={4}>
                ...
                <Col lg={3}>
                  <div className="mb-4">
                    ...
                    <Input
                      ...
                      name="zipcode"
                      defaultValue={adDetails.zipcode}
                    />
                  </div>
                </Col>
                <Col lg={12}>
                ...
                <Col lg={12}>
                  <div className="d-flex flex-wrap align-items-start gap-1 justify-content-end">
                    <Link to="/manageads" className="btn btn-success">
                      {t("back_button")}
                    </Link>
